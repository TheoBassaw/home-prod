locals {
  ...
  control_servers = {
    "control_server_1" = { ip = "10.30.16.3", availability_domain = "wkHw:US-ASHBURN-AD-1", hostname = "control-server-1" }
    "control_server_2" = { ip = "10.30.16.4", availability_domain = "wkHw:US-ASHBURN-AD-3", hostname = "control-server-2" }
  }
}
